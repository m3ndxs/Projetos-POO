using Example_Linq_Lambda.Entities;
using System.Collections.Generic;
using System.Linq;

namespace Example_Linq_Example
{
    class Program {
        ...
        static void Main(string[] args) { 
            ...
            Console.WriteLine("Sing Or Default test1: " + r8);
            Console.WriteLine();

            var r9 = products.Max(p => p.Price);
            Console.WriteLine("Price MAX: " + r9);

            var r10 = products.Min(p => p.Price);
            Console.WriteLine("Price MAX: " + r10);
